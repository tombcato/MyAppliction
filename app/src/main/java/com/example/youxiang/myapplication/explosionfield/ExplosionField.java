 ...
 */
package com.example.youxiang.myapplication.explosionfield;
...
public class ExplosionField extends View {
    ...
    public void setOnExplosionListener(ExplosionListener listener){
    ...
    public void resetView(View root){
        root.setScaleX(1);
        root.setScaleY(1);
        root.setAlpha(1);
    }
